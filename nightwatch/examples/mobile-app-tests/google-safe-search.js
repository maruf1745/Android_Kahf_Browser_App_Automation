describe('Google Safe Search', function(){
  before(function(app){
      app
  ...
  it('Google Safe Search for Default(Low) mode', async function(app) {
      app
  ...
  it('Google Safe Search for Medium mode', async function(app) {
      app
      .click('xpath', '//android.widget.ImageView[@resource-id="io.kahf.browser:id/kahfSettingsButton"]')
      .pause(5000)
  ...
  it('Google Safe Search for High mode', async function(app) {
      app
      .click('xpath', '//android.widget.ImageView[@resource-id="io.kahf.browser:id/kahfSettingsButton"]')
      .pause(5000)
